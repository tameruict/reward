...
export type RedeemInfoPromotion = BasePromotion<{
    [key: string]: string;
} | null, string, string, string, ExclusiveLockedFeature, RedeemInfoPromotionPromotionType> & {
    subtitle?: string;
    isNew?: boolean;
    completionDate?: Date;
...
export declare enum ShowcaseTitle {
    Empty = "",
    GoToDashboard = "Go to dashboard",
    SearchAndEarn = "Search and earn",
    StartEarningPoints = "Start Earning Points"
}
export declare enum ProgressTextFormat {
    B0B1Days = "<b>{0}</b>/{1} days",
    B0B1Points = "<b>{0}</b>/{1} points"
}
export declare enum RedeemInfoPromotionPromotionSubtype {
    Dailyoffer = "dailyoffer",
    Donate = "donate",
    Earn = "earn",
    Empty = ""
}
export declare enum RedeemInfoPromotionPromotionType {
    Badge = "badge",
    Empty = "",
    Search = "search",
    Tip = "tip",
...
export declare enum ShowcaseDescription {
    EarnPointsWhileLearningAboutHowToEarnPointsWinWin = "Earn points while learning about how to earn points. Win-win!",
    Empty = ""
}
export declare enum MorePromotionShowcaseTitle {
    Empty = "",
    SearchAndEarn = "Search and earn",
    The50Points = "50 points"
}
export type PromotionText = string | null;
export interface BasePromotion<TAttributes = Record<string, any> | null, // Keep any
TTitleStyle = string, TDescriptionStyle = string, TLegalLinkText = string, TExclusiveLockedFeatureCategory = ExclusiveLockedFeature, TPromotionType = string> {
    name: string | null;
    priority: number;
...
export declare enum VariableGoalSpecificTitle {
    Empty = "",
...
export type DashboardImpression = BasePromotion<{
    [key: string]: string;
} | null, string, string, string, ExclusiveLockedFeature, DashboardImpressionPromotionType>;
export declare enum DescriptionEnum {
    EarnUpTo15PointsPerDay3PointsPerSearch = "Earn up to 15 points per day, 3 points per search",
    Empty = ""
}
export declare enum DashboardImpressionPromotionSubtype {
    Empty = "",
    Streaks = "streaks"
}
export declare enum DashboardImpressionPromotionType {
    Coachmarks = "coachmarks",
    Empty = "",
    Search = "search"
}
...
export type PromotionalItem = BasePromotion<PromotionalItemAttributes, Style, Style, string, ExclusiveLockedFeature, Type>;
...
export type PurplePromotionalItem = BasePromotion<PurplePromotionalItemAttributes, Style, Style, string, ExclusiveLockedFeature, Type>;
...
export declare enum ParentPunchcards {
...
export type MorePromotion = BasePromotion<{
    [key: string]: string;
}, Style, Style, string, ExclusiveLockedFeature, MorePromotionPromotionType>;
export declare enum ExclusiveLockedFeatureStatus {
    Locked = "locked",
    Unlocked = "unlocked",
    Notsupported = "notsupported"
}
export declare enum MorePromotionPromotionType {
    Empty = "",
    Urlreward = "urlreward",
    Welcometour = "welcometour"
}
