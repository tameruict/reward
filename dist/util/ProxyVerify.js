...
exports.CLOUDFLARE_TRACE_URL = void 0;
exports.parseCloudflareTrace = parseCloudflareTrace;
exports.evaluateProxyIdentity = evaluateProxyIdentity;
...
exports.CLOUDFLARE_TRACE_URL = 'https://www.cloudflare.com/cdn-cgi/trace';
function parseCloudflareTrace(body) {
    ...
    for (const line of body.split(/\r?\n/)) {
        ...
        if (key === 'ip')
            ...
            trace.country = value.toUpperCase();
    }
    return trace;
}
/**
 ...
 */
function evaluateProxyIdentity(params) {
    const mismatches = [];
