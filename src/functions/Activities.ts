...
import type { ClaimBonusResult } from './activities/api/ClaimBonusPoints'
...
export default class Activities {
    ...
    doClaimBonusPoints = async (): Promise<ClaimBonusResult> => {
        const claimBonusPoints = new ClaimBonusPoints(this.bot)
        return await claimBonusPoints.claimBonusPoints()
    }
