...
exports.createCursor = exports.getRandomPagePoint = exports.getCDPClient = exports.installMouseHelper = void 0;
exports.path = path;
var debug_1 = __importDefault(require("debug"));
var math_1 = require("./math");
var mouse_helper_1 = require("./mouse-helper");
Object.defineProperty(exports, "installMouseHelper", { enumerable: true, get: function () { return mouse_helper_1.installMouseHelper; } });
...
var getElementBox = function (page_1, element_1) {
    ...
    return __awaiter(void 0, __spreadArray([page_1, element_1], __read(args_1), false), void 0, function (page, element, relativeToMainFrame) {
        var cdpClient, objectId, quads, elementBox, frameBox, _1;
        if (relativeToMainFrame === void 0) { relativeToMainFrame = true; }
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 8, , 10]);
                    return [4 /*yield*/, (0, exports.getCDPClient)(page)];
                case 1:
                    cdpClient = _a.sent();
                    return [4 /*yield*/, element.evaluate(function (el) {
                            // Get the remote object ID for CDP
                            return el[Symbol.for('pwPlaywrightRemoteObjectId')] || undefined;
                        })];
                case 2:
                    objectId = _a.sent();
                    if (!(objectId === undefined)) return [3 /*break*/, 4];
                    return [4 /*yield*/, element.boundingBox()];
                case 3: return [2 /*return*/, _a.sent()];
                case 4: return [4 /*yield*/, cdpClient.send('DOM.getContentQuads', {
                        objectId: objectId
                    })];
                case 5:
                    quads = _a.sent();
                    ...
                    if (!!relativeToMainFrame) return [3 /*break*/, 7];
                    return [4 /*yield*/, element.evaluate(function (el) {
                            var _a, _b;
                            var frame = (_b = (_a = el.ownerDocument) === null || _a === void 0 ? void 0 : _a.defaultView) === null || _b === void 0 ? void 0 : _b.frameElement;
                            if (frame != null) {
                ...
                case 6:
                    ...
                    _a.label = 7;
                case 7: return [2 /*return*/, elementBox];
                case 8:
                    _1 = _a.sent();
...
var clampPositive = function (vectors, options) {
    ...
    return (options === null || options === void 0 ? void 0 : options.useTimestamps) === true
...
/**
   ...
   * @default false
   */
performRandomMoves, defaultOptions, visible) {
    ...
    var tracePath = function (vectors_1) {
        ...
        return __awaiter(void 0, __spreadArray([vectors_1], __read(args_1), false), void 0, function (vectors, abortOnMove) {
            var vectors_2, vectors_2_1, v, error_1, e_1_1;
            var e_1, _a;
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        _b.label = 1;
                    case 1:
                        if (!!vectors_2_1.done) return [3 /*break*/, 6];
                        v = vectors_2_1.value;
                        _b.label = 2;
                    case 2:
                        _b.trys.push([2, 4, , 5]);
                        ...
                        return [4 /*yield*/, page.mouse.move(v.x, v.y)];
                    case 3:
                        // Use Playwright's native mouse movement
                        _b.sent();
                        previous = v;
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 3:
                    ...
                    previous = rand;
                    _a.label = 4;
                case 4: return [4 /*yield*/, delay(optionsResolved.moveDelay *
    ...
    var actions = {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 3:
                            _a.sent();
                            // Use Playwright's native click method
                            return [4 /*yield*/, page.mouse.click(previous.x, previous.y, {
                        ...
                        case 5:
                            ...
                            return [3 /*break*/, 6];
                        case 6: return [4 /*yield*/, delay(optionsResolved.moveDelay *
                                (optionsResolved.randomizeMoveDelay ? Math.random() : 1))];
                        case 7:
                            _a.sent();
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            _a.sent();
                            actions.toggleRandomMove(wasRandom);
                            return [4 /*yield*/, delay(optionsResolved.moveDelay *
                                    (optionsResolved.randomizeMoveDelay ? Math.random() : 1))];
                        case 2:
                            _a.sent();
                            return [2 /*return*/];
        ...
        scrollIntoView: function (selector, options) {
            return __awaiter(this, void 0, void 0, function () {
                var optionsResolved, scrollSpeed, elem, _a, viewportWidth, viewportHeight, docHeight, docWidth, scrollPositionTop, scrollPositionLeft, elemBoundingBox, elemBox, marginedBox, marginedBoxRelativeToDoc, targetBox, top, left, bottom, right, isInViewport, manuallyScroll, _b, e_2;
                var _this = this;
                    ...
                    switch (_c.label) {
                        ...
                        case 3:
                            ...
                            targetBox = {
                                ...
                                bottom: Math.min(marginedBoxRelativeToDoc.bottom, docHeight) -
                                    scrollPositionTop,
                                right: Math.min(marginedBoxRelativeToDoc.right, docWidth) -
                                    scrollPositionLeft
                            };
                        ...
                        case 5:
                            ...
                            return [4 /*yield*/, elem.scrollIntoViewIfNeeded()];
                        case 6:
                            // Use Playwright's native scrollIntoViewIfNeeded
                            _c.sent();
                            return [3 /*break*/, 9];
                        ...
                        case 13:
                            ...
                            log('Falling back to JS scroll method', e_2);
                            return [4 /*yield*/, elem.evaluate(function (e) {
        ...
        scroll: function (delta, options) {
            return __awaiter(this, void 0, void 0, function () {
                var optionsResolved, scrollSpeed, deltaX, deltaY, xDirection, yDirection, largerDistanceDir, _a, largerDistance, shorterDistance, EXP_SCALE_START, largerDistanceScrollStep, numSteps, largerDistanceRemainder, shorterDistanceScrollStep, shorterDistanceRemainder, i, longerDistanceDelta, shorterDistanceDelta, _b, deltaX_1, deltaY_1;
                var _c, _d;
                return __generator(this, function (_e) {
                    switch (_e.label) {
                        ...
                        case 1:
                            ...
                            return [4 /*yield*/, page.mouse.wheel(deltaX_1, deltaY_1)];
                        case 2:
                            // Use Playwright's native wheel method
                            _e.sent();
                            _e.label = 3;
        ...
        getElement: function (selector, options) {
            return __awaiter(this, void 0, void 0, function () {
                var optionsResolved, elem, xpathSelector;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            xpathSelector = "xpath=".concat(selector);
                            if (!(optionsResolved.waitForSelector !== undefined)) return [3 /*break*/, 2];
                            return [4 /*yield*/, page.waitForSelector(xpathSelector, {
                                    timeout: optionsResolved.waitForSelector
                                })];
                        case 1:
                            _a.sent();
                            _a.label = 2;
                        case 2: return [4 /*yield*/, page.$(xpathSelector)];
                        case 3:
                            elem = (_a.sent());
                            return [3 /*break*/, 8];
                        case 4:
    ...
    if (visible) {
        var removeMouseHelper = (0, mouse_helper_1.installMouseHelper)(page).then(function (_a) {
            var removeMouseHelper = _a.removeMouseHelper;
